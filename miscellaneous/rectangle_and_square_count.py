...
#
# Count the total number of square, rectangle or others. A square is not considered a rectangle, invalid input and non-rectangle and non-square will be counted as others.
...
def are_all_positive_numbers(edges):
    return all([lambda x: x > 0 for x in edges]);
...
print(" ".join(map(str, [shape_type_count['square'], shape_type_count['rectangle'], shape_type_count['others']])))                    
