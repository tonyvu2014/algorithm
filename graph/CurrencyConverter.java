 ...
 */
 ...
 public class CurrencyConversionQuery {
    ...
    public static void main(String[] args) {
        ...
        conversion3.setSource("GBP").setDestination("USD").setRate(1.3);
        Conversion conversion6 = new Conversion();
        conversion4.setSource("USD").setDestination("GBP").setRate(1/1.3);
        ...
        int n = 3;
        String[] sources =  {"USD", "AUD", "GBP"};
        String[] destinations = {"AUD", "GBP", "JPY"};
    ...
    public static Double getConversionRate(ConversionGraph graph, String source, String destination) {
        ...
        while (!currencyQueue.isEmpty()) {
            ...
            List<Conversion> conversions = graph.getConversionMap();
